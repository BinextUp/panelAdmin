import 'package:cwt_ecommerce_admin_panel/common/widgets/custom_shapes/containers/circular_container.dart';
            ...
            () => DataTable(
              ...
              rows: controller.orderStatusData.entries.map((entry) {
                ...
                return DataRow(cells: [
                  ...
                  DataCell(Text('\$$totalAmount')), // Format as needed
                ]);
              }).toList(),
            ),
          ),
  ...
  Color getOrderStatusColor(OrderStatus status) {
    ...
    switch (status) {
      case OrderStatus.pending:
        return TColors.primary.withOpacity(0.4);
